...
layers = [None, 'ibl', 'barrel', 'endcap', 'b1', 'b2', 'b3']
eta_list = [None]
...
def sql_where(truth, layer=None, eta=None):
    ...
    if layer == 'ibl':
        ...
        wlist.append('(NN_barrelEC == 0 AND NN_layer == 1)')
    elif layer == 'b2':
        wlist.append('(NN_barrelEC == 0 AND NN_layer == 2)')
    elif layer == 'b3':
        wlist.append('(NN_barrelEC == 0 AND NN_layer == 3)')
...
def sql_position(nparticles, sizeY):
    ...
    for i in range(nparticles):
        ...
        selected.append('NN_position_id_Y_%d_TRUTH' % i)
        selected.append('NN_position_id_Y_%d_PRED' % i)  
        
    for i in range(nparticles):          
        selected.append('NN_position_id_X_%d_PRED_UNCERT' % i)
        selected.append('NN_position_id_Y_%d_PRED_UNCERT' % i)
